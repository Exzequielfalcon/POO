...
public class Trabajo2 {
	...
	public static void CargarMatrizTeclado(int[][] mat) {
	...
	int a=0;
		for (int con = 0 ; con < maxF; con++){
			for (int i=0; i<maxC; i++){
				...
				System.out.println("Ingrese 100 numeros");
